...
static void logger_file_write_header(FILE *file) {
  ...
  fprintf(file, "divergence,true_divergence,divergence_sp,");
  fprintf(file, "pitch_sum,raw_divergence,color_count,");
#ifdef BOARD_BEBOP
...
static void logger_file_write_row(FILE *file) {
  ...
  fprintf(file, "%f,%f,%f,", visual_servoing.divergence, visual_servoing.true_divergence, visual_servoing.divergence_sp);
  fprintf(file, "%f,%f,%f,", visual_servoing.pitch_sum, visual_servoing.raw_divergence, visual_servoing.color_count);
#ifdef BOARD_BEBOP
